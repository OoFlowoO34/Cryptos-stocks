...
fetch("https://p2bjpwhw.directus.app/items/symboles")
  ...
  .then((data) => {
    for (let i = 0; i < data["data"].length; i++) {
      ...
      if (toggle_crypto == false) {
        let color = ["#F89D30", "#5057FF", "#FF4646", "#52B05C", "#C4C4C4"];
        color = color[i];
        console.log(color);
        const divcircle_crypto = document.createElement("div");
        divcircle_crypto.innerHTML =
          '<div class="circlesymbole" id="bourse_color_symbole' +
          i +
          '">' +
          "</div>" +
          "<span>" +
          data["data"][i].symbole_name +
          "</span>";
        ...
        let bourse_symbolelist = document.getElementById("bourse_symbolelist");
        bourse_symbolelist.insertAdjacentHTML(
          "afterbegin",
          divcircle_crypto.outerHTML
        );
        bourse_chart.appendChild(div);
      } else {
        console.log("else" + i);
        let color = ["#F89D30", "#5057FF", "#FF4646", "#52B05C", "#C4C4C4"];
        color = color[i];
        ...
        divcircle.innerHTML =
          '<div class="circlesymbole" id="crypto_color_symbole' +
          i +
          '">' +
          "</div>" +
          "<span>" +
        ...
        crypto_symbolelist.insertAdjacentHTML(
          "afterbegin",
          divcircle.outerHTML
        );
        crypto_chart.appendChild(div);
      }
